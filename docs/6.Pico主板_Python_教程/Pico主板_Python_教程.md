...
![图片不存在](./media/7961629ea63a368800c85121164c0481.jpg)
...
![图片不存在](./media/e042660621dab18970de47c4ee72b78b.png)
...
![图片不存在](./media/507d3ab693660f714f19c3b9ed43e538.jpg)
...
![图片不存在](./media/76d9ec5c66b0e941ec273d1ce7915ada.png)
...
![图片不存在](./media/4cf1f996dff2f42e0baf95af9020ddf4.png)

![图片不存在](./media/3eb1fbab8657db481d02f8a09bd012a1.png)

打开Thonny软件，先单击“**此电脑**”，再双击“Software (D:)”找到文件夹“Project_17_I2C_LCD_1602”。

![图片不存在](./media/e6203f69d13721c8323f6d88c03f04b7.png)

![图片不存在](./media/e4ad2a3de382a8d976f8a771a0562286.png)

![图片不存在](./media/56f12bb42275c9bdd314a05e57e2c21a.png)

双击文件夹“Project_17_I2C_LCD_1602”，分别右键点击“I2C_LCD.py”和“LCD_API.py”，选择“上传到/”。

![图片不存在](./media/56f12bb42275c9bdd314a05e57e2c21a.png)

![图片不存在](./media/02db1c18132b3b11bef82fe254028c53.png)

![图片不存在](./media/968628ce9e4c710b6e6233175df41e41.png)

这样，库文件添加好了。

![图片不存在](./media/6ca64f706d280922031cf05dd9f835fb.png)

6. 在线运行代码：

双击“Project_17_I2C_LCD_1602.py”打开文件。

![图片不存在](./media/94b9d6f057179ad91168f692b1902447.png)
...
按照接线图正确接好模块，利用MicroUSB线连接到计算机上电。单击![图片不存在](./media/4ac0a5cec03a20e095f56686af2e4c0c.png)来执行程序代码，代码开始执行，你会看到的现象是：LCD1602显示屏第一行打印出“ **Hello, world!** ” ，第二行打印出 “**Counter:**”和“**数字**（从数字0逐渐加1）” 。

![图片不存在](./media/9440589768eb79e5a7a835df9356c9dd.png)
...
![图片不存在](./media/32f42271b4c2dd5bdb98aa19d87942eb.png)
...
|![图片不存在](./media/d12071168fd2fd07dcd66e4a187d91bd.png)|![图片不存在](./media/3eb806e0acb028c1b242da3b85c44e58.png)|![图片不存在](./media/06763561566221a1869025569aa0f947.png)|![图片不存在](./media/08cac8e036b616593db2d11a13d7922d.png)|![图片不存在](./media/28c28e6163de71f861c1f8f9bf621ee2.png)|
| :--: | :--: | :--: |:--: |:--: |
...
![图片不存在](./media/494c5a396e782d376f7a5395d7be57a8.png)
...
![图片不存在](./media/67c154663d59193db013a21a45eda0b6.png)
...
![图片不存在](./media/1f36d7191851ce1a689f28b3bc0fcc63.jpg)
...
![图片不存在](./media/f63b81c47d8ba01f0a4764639184569e.png)
...
|![图片不存在](./media/d12071168fd2fd07dcd66e4a187d91bd.png)|![图片不存在](./media/3eb806e0acb028c1b242da3b85c44e58.png)|![图片不存在](./media/0f9d66d0470afaf39a8cec2c76abaca1.png)|![图片不存在](./media/08cac8e036b616593db2d11a13d7922d.png)|![图片不存在](./media/28c28e6163de71f861c1f8f9bf621ee2.png)|
| :--: | :--: | :--: |:--: |:--: |
...
![图片不存在](./media/4dab7389789ecc5b9131cbfa394880ea.png)
...
![图片不存在](./media/d9b7e77f9bf31bd31d79f0dc1ce37fa3.png)
...
按照接线图正确接好模块和各元器件，利用MicroUSB线连接到计算机上电，单击![图片不存在](./media/4ac0a5cec03a20e095f56686af2e4c0c.png)来执行程序代码。代码开始执行，你会看到的现象是：使用手机的照明灯对着光敏传感器模块上的光敏电阻照射，当光敏传感器检测到光照强度的ADC值大于30000时，LED灯熄灭；否则，低于设定值时，LED灯点亮，实现了夜光灯的效果。
...
|![图片不存在](./media/d12071168fd2fd07dcd66e4a187d91bd.png)|![图片不存在](./media/3eb806e0acb028c1b242da3b85c44e58.png)|![图片不存在](./media/7b669a255e2eda49d5aff5b4605891bd.png)|![图片不存在](./media/28c28e6163de71f861c1f8f9bf621ee2.png)|
| :--: | :--: | :--: |:--: |
...
![图片不存在](./media/3b037ad685d2eb8f07f61e89d319ae77.png)
...
![图片不存在](./media/4f3821ff4d54d0acaf0108ebd6c1ad3c.png)
...
按照接线图正确接好模块和各元器件，利用MicroUSB线连接到计算机上电，单击![图片不存在](./media/4ac0a5cec03a20e095f56686af2e4c0c.png)来执行程序代码。代码开始执行，你会看到的现象是：对准模块上的MIC头大声说话（或大呼气），当声音传感器接收到的声音对应的ADC值大于10000时，LED灯亮起5秒，然后熄灭，实现声控灯的效果。

![图片不存在](./media/49df2509e1e5d885a2159ea08aa72176.jpg)
...
![图片不存在](./media/f6688abed40cc3e3813369363d3f45b3.png)
...
按照接线图正确接好模块和各元器件，利用MicroUSB线连接到计算机上电，单击![图片不存在](./media/4ac0a5cec03a20e095f56686af2e4c0c.png)来执行程序代码。代码开始执行，你会看到的现象是：在水滴传感器模块上的感应区滴一两滴水，当水滴传感器检测水量大小输出的ADC值大于30000时，有源蜂鸣器发出警报，外接LED灯快速闪烁，实现雨水警报的效果。
...
|![图片不存在](./media/d12071168fd2fd07dcd66e4a187d91bd.png)|![图片不存在](./media/3eb806e0acb028c1b242da3b85c44e58.png)|![图片不存在](./media/76f627868e96dc6bb14bfff4afc44300.png)|![图片不存在](./media/08cac8e036b616593db2d11a13d7922d.png)|![图片不存在](./media/5a0d069fdb6c0f5901be9f9e2bd07e7d.png)|
| :--: | :--: | :--: |:--: |:--: |
...
![图片不存在](./media/18454403e839b160704cd4fec8993020.jpg)
...
![图片不存在](./media/bcaa6f2193858525dfba568e97e899a2.png)

![图片不存在](./media/61c3318249048cb208b890dd5eda545e.png)
...
![图片不存在](./media/7e4e71458ab559b3de153da9d2cc1e51.png)

双击文件夹“Project_25_Smoke_Alarm”，分别右键点击“I2C_LCD.py”和“LCD_API.py”，选择“上传到/”。

![图片不存在](./media/7e4e71458ab559b3de153da9d2cc1e51.png)

![图片不存在](./media/a6d936e240f05ba2d0566229f29f45a0.png)

![图片不存在](./media/3d7a75ae62c979b2f296bc9e1d0da19c.png)

这样，库文件添加好了。

![图片不存在](./media/e0c02e810f31dfa7d6bc97ee580b5fcf.png)

5. 在线运行代码：

双击“Project_25_Smoke_Alarm.py”打开文件。

![图片不存在](./media/d06e8de3589b2428c9408dc37296badc.png)
...
按照接线图正确接好模块和各元器件，利用MicroUSB线连接到计算机上电，单击![图片不存在](./media/4ac0a5cec03a20e095f56686af2e4c0c.png)来执行程序代码。代码开始执行，你会看到的现象是：1602LCD显示屏显示烟雾或可燃性气体相应的ADC值，当模拟气体(MQ-2)传感器检测到烟雾或可燃性气体的ADC值大于35000时，有源蜂鸣器发出警报。

![图片不存在](./media/125e10ec3ac3290f4e7e4e25bb879a19.jpg)
...
|![图片不存在](./media/d12071168fd2fd07dcd66e4a187d91bd.png)|![图片不存在](./media/3eb806e0acb028c1b242da3b85c44e58.png)|![图片不存在](./media/76f627868e96dc6bb14bfff4afc44300.png)|![图片不存在](./media/08cac8e036b616593db2d11a13d7922d.png)|![图片不存在](./media/28c28e6163de71f861c1f8f9bf621ee2.png)|
| :--: | :--: | :--: |:--: |:--: |
|树莓派Pico主板*1|面包板*1|模拟气体(MQ-2)传感器模块*1|有源蜂鸣器模块*1|红色LED*1|
|![图片不存在](./media/3ee049150a7d8652a0d07b3b451b3346.png)|![图片不存在](./media/7b669a255e2eda49d5aff5b4605891bd.png)|![图片不存在](./media/08e338f485a7699613f8e902884a1991.png)|![图片不存在](./media/0f9d66d0470afaf39a8cec2c76abaca1.png)|![图片不存在](./media/11f324f82f890b0691f134e1ea7a3765.png)|
|水滴传感器模块*1|声音传感器模块*1|LCD1602显示屏模块*1|火焰传感器模块*1|220Ω电阻*1|
|![图片不存在](./media/dda94299cc2abaff2c9cb8ff7ce365ff.jpg)|![图片不存在](./media/a6ff46e05db89a18ffe62f2f6c66c701.png)| ![图片不存在](./media/8d920d12138bd3b4e62f02cecc2c63a3.png)| ![图片不存在](./media/5a0d069fdb6c0f5901be9f9e2bd07e7d.png)| |
|公对母杜邦线若干|MicroUSB线*1|面包板连接线若干|一字螺丝刀*1 | |

3. 项目接线图：

![图片不存在](./media/7f6350ba18b515425e83758e0744c159.png)
...
![图片不存在](./media/cba2852646abeaff77baac3aac2cfc98.png)
...
![图片不存在](./media/e1d607129b850dd23d0605f2b7a5274e.jpg)
